...
import { Scale, Shield, Code, FileText, AlertCircle, Users } from "lucide-react";
      ...
      <div className="container mx-auto px-6 py-12 relative z-0 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg mb-6">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">Original Content Statement</h3>
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">Technical Implementation</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg mb-6">
            ...
            <h3 className="font-semibold text-lg mt-4 mb-3 text-foreground">Usage License</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">Disclaimer</h3>
            <ul className="list-disc list-inside space-y-2 text-foreground/80">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">Privacy Protection</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">Contact Us</h3>
            <p className="text-foreground/80 leading-relaxed">
              If you have any questions about copyright, technical implementation, or other aspects of this website,
              please contact us at <strong>contact@haoin.tech</strong>
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground/80">
              ...
              <li><strong>Advertising:</strong> May display third-party ads (Google AdSense) to support free services</li>
            </ul>

            <p className="text-foreground/80 leading-relaxed mt-4">
              We are committed to ensuring the lawful use of all third-party content. If you discover any infringing content,
              please contact us immediately at <strong>contact@haoin.tech</strong>, and we will address it within 24 hours.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg mb-6">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">DMCA Takedown Notice Requirements</h3>
            <p className="text-foreground/80 leading-relaxed mb-3">Your notice must include the following information:</p>
            <ul className="list-disc list-inside space-y-2 text-foreground/80">
            ...
            <h3 className="font-semibold text-lg mt-6 mb-3 text-foreground">DMCA Designated Agent</h3>
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 p-4 rounded-lg">
              <p className="text-foreground"><strong>Copyright Agent - Haoin Tools</strong></p>
              <p className="text-foreground mt-2">Email: <strong>contact@haoin.tech</strong></p>
              <p className="text-foreground mt-1">Subject Line: "DMCA Takedown Notice"</p>
            </div>
          ...
          <div className="text-center text-sm text-muted-foreground pt-4 pb-8">
            ...
            <p className="mt-2">Haoin Tech Co., Ltd. (杭州皓萤科技有限公司)</p>
