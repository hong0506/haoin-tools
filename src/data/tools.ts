...
export const categories: Category[] = [
  ...
  { id: "text", name: "Text Tools", icon: "Type", path: "/category/text" },
  {
    id: "converter",
    name: "Converters",
    icon: "Repeat",
  ...
  { id: "design", name: "Design", icon: "Palette", path: "/category/design" },
  {
    id: "security",
    name: "Security",
    icon: "Shield",
...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    title: "API Tester",
    description:
      "Test REST APIs by sending HTTP requests and inspecting responses",
    category: "developer",
    badge: "Developer",
    badgeVariant: "purple",
